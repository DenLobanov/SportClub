...
public class MemberCursorAdapter extends CursorAdapter {
    ...
    public void bindView(View view, Context context, Cursor cursor) {
        ...
        String firstName = cursor.getString(cursor.getColumnIndexOrThrow(ClubContract.MemberEntry.KEY_FIRST_NAME));
        String lastName = cursor.getString(cursor.getColumnIndexOrThrow(ClubContract.MemberEntry.KEY_LAST_NAME));
        String sport = cursor.getString(cursor.getColumnIndexOrThrow(ClubContract.MemberEntry.KEY_KIND));
